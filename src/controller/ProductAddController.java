...
/**
 * FXML Controller class for the AddProductScreen.FXML document. This class has
 * methods for saving new products as well as adding any number of parts to those
 * products then saving to the inventory system. The functional methods are 
 * called by the various button elements and on various textual elements.
 *
 * @author sjpaige
 */
public class ProductAddController implements Initializable{
     ...
     * @param url file path
     * @param rb a bundle of resources
     */
    @Override
    public void initialize(URL url, ResourceBundle rb) {
        //On initialize it loads the parts that can be added to a product
    ...
    private void saveAction(ActionEvent event) throws IOException, Exception {
         save(event, name,price, stock, max, min); //On button trigger save function
    }
   ...
   /**
    ...
    private void save( ActionEvent event, 
        ...
        TextField minField) throws IOException, Exception{
            ...
            try{
                ...
                int id = IdGenerator.getNewProductID(); //New ID
                ...
                Inventory.addProduct(productBeingSaved);
    ...
    /**
     * A method that adds up all the parts that are being added so that
     * they can be compared for the PriceException
     * @param partsToSum takes an ObservableList of parts usually partsBeingAssociated
     * @return the sum as a double
     */
    public static double sumPartsPrice(ObservableList<Part> partsToSum){
        double sum = 0;
        for(Part part : partsToSum){
